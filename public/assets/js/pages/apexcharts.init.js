...
options = {
    ...
    series: [{
        name: "المدرسة الإعدادية النموذجية بالعمران",
        data: [46, 57, 59, 54, 62, 58, 64, 60, 66]
    }, {
        name: "المدرسة الإعدادية النموذجية بالبحيرة",
        data: [74, 83, 102, 97, 86, 106, 93, 114, 94]
    }, {
        name: "المدرسة الإعدادية النموذجية ببرجو",
        data: [37, 42, 38, 26, 47, 50, 54, 55, 43]
    }],
    colors: ["#23c58f", "#525ce5", "#f14e4e"],
    xaxis: {
        categories: ["جانفي", "فيفري", "مارس", "أفريل", "ماي", "جوان", "جويلية", "أوت", "سبتمبر"]
    },
    yaxis: {
        title: {
            text: "(التلاميذ)"
...
options = {
    ...
    /*
    lycée pilote Lac, collège Bargou
     */
    series: [{
        name: "المدرسة الإعدادية النموذجية بالعمران",
        data: [46, 57, 59, 54, 62, 58, 64, 60, 66]
    ...
    colors: ["#23c58f", "#525ce5", "#ad57ad"],
    xaxis: {
        categories: ["جانفي", "فيفري", "مارس", "أفريل", "ماي", "جوان", "جويلية", "أوت", "سبتمبر"]/*,"أكتوبر","نوفمبر","ديسمبر"*/
    },
    yaxis: {
        title: {
            text: "(الحجوزات)"
...
(chart = new ApexCharts(document.querySelector("#column_chart_restau1"), options)).render();
/****************stat foyer*********************/
options = {
    chart: {
        height: 350,
    ...
    series: [{
        name: "التلاميذ المقيمين",
        data: [550,600,450,500,400,570]
    }],
    colors: ["#525ce5"],
    grid: {
        borderColor: "#f1f1f1",
    ...
    title: {
        text: "الإحصائيات السنوية للتلاميذ المقيمين",
        floating: !0,
        offsetY: 320,
        align: "center",
        style: {
...
(chart = new ApexCharts(document.querySelector("#column_chart_foyer"), options)).render();
/*************************************/
options = {
    chart: {
        height: 350,
